...
function Nina() {
  return (
    <div>
      ...
      <div style = {{backgroundColor: "mintgreen", padding: "10px", marginBottom: "1px", marginLeft: "1cm", alignItems: "center", marginTop: "2in", display: "flex", felxDirection: "column", paddingLeft: "2in"}}>
