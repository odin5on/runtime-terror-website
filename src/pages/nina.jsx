...
function Nina() {
  return (
    <div>
      ...
      <div style = {{backgroundColor: "lightpurple", paddingLeft: "10px", paddingRight: "10px", marginBottom: "1px", alignItems: "center", marginTop: "2in", display: "flex", felxDirection: "row", marginLeft: "1cm", }}>
