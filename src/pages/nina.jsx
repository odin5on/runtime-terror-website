...
function Nina() {
  return (
    <div>
      <h1 style = {{fontWeight: "bold", fontSize: "24px", backgroundColor: "lightblue", padding: "10px", borderRadius: "5px", marginBottom: "10px", marginLeft: "1cm", marginBottom: "1.5cm"}}> Nina Baffo</h1>
