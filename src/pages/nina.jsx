...
function Nina() {
  return (
    <div>
      ...
      <div style = {{backgroundColor: "lightgreen", padding: "10px", borderRadius: "10px", marginBottom: "10px", marginLeft: "1cm", display: "flex", alignItems: "center", marginTop: "2in", display: "flex", felxDirection: "column", paddingLeft: "2in"}}>
