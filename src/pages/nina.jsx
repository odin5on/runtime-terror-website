    ...
    <div>
      ...
      <div style = {{ backgroundColor: "lavender", padding: "10px", borderRadius: "5px", marginBottom: "10px", marginLeft: "1cm", marginRight: "1cm", display: "flex", alignItems: "center" }}>
       <div style={{ marginRight: "1cm", marginLeft: "1cm"}}>
        <img src = "src/pages/IMG_3307.jpeg" style = {{width: "300px", marginRight: "1cm", marginBottom: "1cm"}} />
        ...
        <div style={{ marginRight: "1cm", marginLeft: "1cm" }}>
        <img src = "src/pages/IMG_5860.jpeg" style = {{width: "300px", marginRight: "1cm", marginBottom: "0.5cm"}}/>
        ...
        <div style={{ marginRight: "1cm", marginLeft: "1cm" }}>
        <img src = "src/pages/IMG_8281.jpeg" style = {{width: "800px", marginRight: "1cm", marginBottom: "1cm"}}/>
